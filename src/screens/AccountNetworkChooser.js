  ...
  render() {
    ...
    return (
      <ScrollView style={styles.body} contentContainerStyle={{ padding: 20 }}>
        ...
        { Object.entries(NETWORK_LIST).map(([networkKey,networkParams], index) => (
          <TouchableItem
            key={index}
            style={[
              styles.card,
            ...
            onPress={() => {
              ...
              if (networkParams.protocol === networkProtocols.ETHEREUM){
                accounts.updateNew({
                  ethereumChainId: NETWORK_LIST[networkKey].ethereumChainId,
                  networkKey,
